        ...
        <div class="container-xl" style="padding-top:150px;">
            <div class="table-responsive" style="overflow-x: hidden;">
                <div class="table-wrapper">
                    ...
                    <form action="{{ route('update', ['id' => $country['id']]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <table class="table table-striped table-hover text-center">
                            ...
                            <tbody>
                                    <td>
                                        <input value="{{ $country['name']['ar'] }}" name="name_ar" placeholder="name arabic"/>
                                    </td>
                                    <td>
                                        <input value="{{ $country['name']['en'] }}" name="name_en" placeholder="name english"/>
                                    </td>
                                    <td>
                                        <input value="{{ $country['description']['ar'] }}" name="description_ar" placeholder="description arabic"/>
                                    </td>
                                    <td>
                                        <input value="{{ $country['description']['en'] }}" name="description_en" placeholder="description english"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
